                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="space-y-8 animate-fade-in-up">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            <a href="#inquire" className="bg-primary hover:bg-blue-600 text-white px-8 py-3 rounded font-medium transition flex items-center justify-center shadow-md hover:shadow-lg">
                                <span className="material-icons-outlined mr-2 text-sm">search</span> Inquire about Services
                            </a>
                            <a href="https://nervous-system-quiz-391148693749.us-west1.run.app/" target="_blank" rel="noopener noreferrer" className="bg-white dark:bg-surface-dark border border-gray-300 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 text-slate-700 dark:text-white px-8 py-3 rounded font-medium transition flex items-center justify-center shadow-sm">
                                <span className="material-icons-outlined mr-2 text-sm">assignment</span> Take the Quiz
                            </a>
                        </div>
                    </div>
